...
extern UINT location_DVCPluginEntry(IDRDYNVC_ENTRY_POINTS* pEntryPoints);
...
extern UINT ainput_DVCPluginEntry(IDRDYNVC_ENTRY_POINTS* pEntryPoints);
...
extern const STATIC_ENTRY CLIENT_DVCPluginEntry_TABLE[];
const STATIC_ENTRY CLIENT_DVCPluginEntry_TABLE[] =
{
	...
	{ "location", (static_entry_fkt)location_DVCPluginEntry },
	...
	{ "ainput", (static_entry_fkt)ainput_DVCPluginEntry },
	{ NULL, NULL }
};
extern const STATIC_ENTRY CLIENT_DeviceServiceEntry_TABLE[];
...
extern UINT libusb_freerdp_urbdrc_client_subsystem_entry(void*);
extern UINT oss_freerdp_rdpsnd_client_subsystem_entry(void*);
extern UINT alsa_freerdp_rdpsnd_client_subsystem_entry(void*);
extern UINT fake_freerdp_rdpsnd_client_subsystem_entry(void*);
extern UINT cups_freerdp_printer_client_subsystem_entry(void*);
extern UINT oss_freerdp_audin_client_subsystem_entry(void*);
extern UINT alsa_freerdp_audin_client_subsystem_entry(void*);
...
extern const STATIC_SUBSYSTEM_ENTRY CLIENT_URBDRC_SUBSYSTEM_TABLE[];
...
extern const STATIC_SUBSYSTEM_ENTRY CLIENT_PRINTER_SUBSYSTEM_TABLE[];
...
const STATIC_ADDIN_TABLE CLIENT_STATIC_ADDIN_TABLE[] =
{
	...
	{ "location", "DVCPluginEntry", (static_addin_fkt)location_DVCPluginEntry, CLIENT_LOCATION_SUBSYSTEM_TABLE },
	...
	{ "ainput", "DVCPluginEntry", (static_addin_fkt)ainput_DVCPluginEntry, CLIENT_AINPUT_SUBSYSTEM_TABLE },
	{ NULL, NULL, NULL, NULL }
};
